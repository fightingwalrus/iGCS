...
- (IBAction)ftpClicked:(id)sender {
    ...
    NSString *filepath = [NSString stringWithFormat: @"%@/%@", applicationDocumentsDir, @"file.txt"];
    _uploadData = [NSData dataWithContentsOfFile: filepath];
    
    _uploadFile = [[BRRequestUpload alloc] initWithDelegate: self];
    
    //----- for anonymous login just leave the username and password nil
    _uploadFile.path = @"myfile.txt";
